...
impl Display for EsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            EsError::ValidationError(msg) => write!(f, "Validation error: {}", msg),
            EsError::IndexingError(msg) => write!(f, "Indexing error: {}", msg),
            EsError::ConnectionError(msg) => write!(f, "Connection error: {}", msg),
            EsError::ApiError(msg) => write!(f, "API error: {}", msg),
            EsError::SerializationError(msg) => write!(f, "Serialization error: {}", msg),
            EsError::Other(msg) => write!(f, "Other error: {}", msg),
        }
    }
}
